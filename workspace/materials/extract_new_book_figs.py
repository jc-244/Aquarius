...
crops each figure into materials/new-book-figures/{page}-{fig_id}.png
...
def get_pages_for_sections(sections: list) -> list:
    ...
    map_path = os.path.join(os.path.dirname(DIR), 'app', 'section-page-map-new.json')
...
if __name__ == "__main__":
    ...
    if explicit_pages:
        ...
        map_path = os.path.join(
            os.path.dirname(DIR), 'app', 'section-page-map-new.json'
        )
        with open(map_path) as f:
            sec_map = json.load(f)
